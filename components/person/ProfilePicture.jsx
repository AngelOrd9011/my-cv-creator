...
import { update_cv_person } from '../../graphql/mutations';
...
export const ProfilePicture = (props) => {
  ...
  const [updatePerfil, resAdd] = useMutation(update_cv_person, UserHeader);
    ...
    <div className="grid">
      <div className="col-12 image-selector-btn">
        <FileUpload
          ...
          auto
        />
        {profile && <Button icon="pi pi-times" className="p-button-rounded p-button-outlined" onClick={deleteImage} />}
      </div>
